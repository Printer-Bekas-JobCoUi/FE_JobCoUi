...
export default function Employers() {
  ...
  const rows = useMemo(() => {
    return seed
      ...
      .filter((e) =>
        q
          ? (e.name + e.bidang + e.domisili + e.id)
              .toLowerCase()
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Pemberi Kerja"
        description="Kelola akun pemberi kerja: verifikasi, reputasi, dan status."
        actions={
          <>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <label className="grid gap-1">
            ...
            <input
              ...
              placeholder="Nama / bidang / domisili / ID"
            />
          </label>
          <label className="grid gap-1">
      ...
      <div className="card overflow-hidden">
        <Table
          columns={[
            ...
            { key: "bidang", title: "Bidang", className: "whitespace-nowrap" },
            {
              key: "fotoUrl",
              title: "Foto",
              className: "whitespace-nowrap",
      ...
      <Modal
        ...
        title={selected ? `Detail Pemberi Kerja • ${selected.name}` : "Detail"}
        onClose={() => {
          setSelected(null);
          setModalMode(null);
        }}
        ...
        {selected && (
          <div className="grid gap-4 sm:grid-cols-2 text-sm">
            <div className="grid gap-2">
              ...
              <div>
                <div className="text-xs text-slate-500">Nama Orang</div>
            ...
            <div>
              ...
              {selected.fotoUrl ? (
                ...
                <div className="w-full bg-slate-100 rounded border border-slate-200 flex items-center justify-center h-64">
                  <span className="text-slate-500">Logo tidak tersedia</span>
                </div>
              )}
            </div>
            <div>
              <div className="text-xs text-slate-600 mb-2 font-semibold">
                KTP Pemilik/Penanda Tangan
              </div>
              {selected.ktpUrl ? (
                <img
                  src={selected.ktpUrl}
